...
classifier=ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/tqeR2INKD/model.json",modelLoaded);
...
function gotResult(error,results){
    if(error){
        ...
        if(results[1].label=="Shocked"){
            document.getElementById("update_emoji1").innerHTML="&#128559";
        }
